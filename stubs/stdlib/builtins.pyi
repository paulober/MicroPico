...
class bytes(ByteString):
    ...
    def format(self, format:str) -> bytes: ...;
...
class bytearray(ByteString):
    ...
    def append(self, value: int) -> bytearray: ...
    def decode(self, encoding: str = ..., errors: str = ...) -> str: ...
    def extend(self, value: int) -> bytearray: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Iterator[int]: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
...
class UnicodeError(_StandardError): ...
