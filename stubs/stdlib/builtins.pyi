...
class object:
    ...
    if sys.version_info >= (3, 8):
        ...
        def __reduce_ex__(self, __protocol: int) -> Union[str, tuple[Any, ...]]: ...
...
class staticmethod(Generic[_R_co]):
    ...
    def __get__(self, __obj: _T, __type: Optional[type[_T]] = ...) -> Callable[..., _R_co]: ...
...
_LiteralInteger = Union[_PositiveInteger, _NegativeInteger, Literal[0]]  # noqa: Y026  # TODO: Use TypeAlias once mypy bugs are fixed

class int:
    @overload
    def __new__(cls: type[Self], __x: str | ReadableBuffer | SupportsInt | SupportsIndex | SupportsTrunc = ...) -> Self: ...
    @overload
    def __new__(cls: type[Self], __x: Union[str, bytes] | bytearray, base: SupportsIndex) -> Self: ...
    if sys.version_info >= (3, 8):
...
class str(Sequence[str]):
    ...
    @overload
    def lstrip(self: LiteralString, __chars: Optional[LiteralString] = ...) -> LiteralString: ...
    @overload
    def lstrip(self, __chars: Optional[str] = ...) -> str: ...  # type: ignore[misc]
    @overload
    ...
    @overload
    def rsplit(self: LiteralString, sep: Optional[LiteralString] = ..., maxsplit: SupportsIndex = ...) -> list[LiteralString]: ...
    @overload
    def rsplit(self, sep: Optional[str] = ..., maxsplit: SupportsIndex = ...) -> list[str]: ...  # type: ignore[misc]
    @overload
    def rstrip(self: LiteralString, __chars: Optional[LiteralString] = ...) -> LiteralString: ...
    @overload
    def rstrip(self, __chars: Optional[str] = ...) -> str: ...  # type: ignore[misc]
    @overload
    def split(self: LiteralString, sep: Optional[LiteralString] = ..., maxsplit: SupportsIndex = ...) -> list[LiteralString]: ...
    @overload
    def split(self, sep: Optional[str] = ..., maxsplit: SupportsIndex = ...) -> list[str]: ...  # type: ignore[misc]
    @overload
    ...
    @overload
    def strip(self: LiteralString, __chars: Optional[LiteralString] = ...) -> LiteralString: ...
    @overload
    def strip(self, __chars: Optional[str] = ...) -> str: ...  # type: ignore[misc]
    @overload
    ...
    def __getitem__(self, __i: Union[SupportsIndex, slice]) -> str: ...
...
class bytes(ByteString):
    ...
    def count(
        self, __sub: Union[ReadableBuffer, SupportsIndex], __start: Optional[SupportsIndex] = ..., __end: Optional[SupportsIndex] = ...
    ) -> int: ...
    def decode(self, encoding: str = ..., errors: str = ...) -> str: ...
    def endswith(
        self,
        __suffix: Union[ReadableBuffer, tuple[ReadableBuffer, ...]],
    ...
    def ljust(self, __width: SupportsIndex, __fillchar: Union[bytes, bytearray] = ...) -> bytes: ...
    def lower(self) -> bytes: ...
    def lstrip(self, __bytes: Optional[ReadableBuffer] = ...) -> bytes: ...
    ...
    def rjust(self, __width: SupportsIndex, __fillchar: Union[bytes, bytearray] = ...) -> bytes: ...
    def rpartition(self, __sep: ReadableBuffer) -> tuple[bytes, bytes, bytes]: ...
    def rsplit(self, sep: Optional[ReadableBuffer] = ..., maxsplit: SupportsIndex = ...) -> list[bytes]: ...
    def rstrip(self, __bytes: Optional[ReadableBuffer] = ...) -> bytes: ...
    def split(self, sep: Optional[ReadableBuffer] = ..., maxsplit: SupportsIndex = ...) -> list[bytes]: ...
    def splitlines(self, keepends: bool = ...) -> list[bytes]: ...
    def startswith(
        self,
        __prefix: Union[ReadableBuffer, tuple[ReadableBuffer, ...]],
        __start: Optional[SupportsIndex] = ...,
        __end: Optional[SupportsIndex] = ...,
    ) -> bool: ...
    def strip(self, __bytes: Optional[ReadableBuffer] = ...) -> bytes: ...
    def swapcase(self) -> bytes: ...
    def title(self) -> bytes: ...
    def translate(self, __table: Optional[ReadableBuffer], delete: bytes = ...) -> bytes: ...
    ...
    # Incompatible with Sequence.__contains__
    def __contains__(self, __o: Union[SupportsIndex, bytes]) -> bool: ...  # type: ignore[override]
    def __eq__(self, __x: object) -> bool: ...
    def __ne__(self, __x: object) -> bool: ...
...
class bytearray(MutableSequence[int], ByteString):
    ...
    def ljust(self, __width: SupportsIndex, __fillchar: Union[bytes, bytearray] = ...) -> bytearray: ...
    def lower(self) -> bytearray: ...
    def lstrip(self, __bytes: Optional[ReadableBuffer] = ...) -> bytearray: ...
    ...
    def rjust(self, __width: SupportsIndex, __fillchar: Union[bytes, bytearray] = ...) -> bytearray: ...
    def rpartition(self, __sep: ReadableBuffer) -> tuple[bytearray, bytearray, bytearray]: ...
    def rsplit(self, sep: Optional[ReadableBuffer] = ..., maxsplit: SupportsIndex = ...) -> list[bytearray]: ...
    def rstrip(self, __bytes: Optional[ReadableBuffer] = ...) -> bytearray: ...
    def split(self, sep: Optional[ReadableBuffer] = ..., maxsplit: SupportsIndex = ...) -> list[bytearray]: ...
    ...
    def strip(self, __bytes: Optional[ReadableBuffer] = ...) -> bytearray: ...
    def swapcase(self) -> bytearray: ...
    def title(self) -> bytearray: ...
    def translate(self, __table: Optional[ReadableBuffer], delete: bytes = ...) -> bytearray: ...
    ...
    @overload
    def __setitem__(self, __s: slice, __x: Union[Iterable[SupportsIndex], bytes]) -> None: ...
    ...
    def __mod__(self, __value: Any) -> bytes: ...
    # Incompatible with Sequence.__contains__
    def __contains__(self, __o: Union[SupportsIndex, ReadableBuffer]) -> bool: ...  # type: ignore[override]
    def __eq__(self, __x: object) -> bool: ...
    def __ne__(self, __x: object) -> bool: ...
    def __lt__(self, __x: bytes) -> bool: ...
    def __le__(self, __x: bytes) -> bool: ...
...
class memoryview(Sized, Sequence[int]):
    ...
    @property
    def suboffsets(self) -> Optional[tuple[int, ...]]: ...
    @property
    def readonly(self) -> bool: ...
    @property
    def ndim(self) -> int: ...
    @property
    def obj(self) -> Union[bytes, bytearray]: ...
    @property
...
def ord(__c: Union[str, bytes] | bytearray) -> int: ...
...
@overload
def print(
    *values: object, sep: Optional[str] = ..., end: Optional[str] = ..., file: _SupportsWriteAndFlush[str] | None = ..., flush: bool
) -> None: ...
