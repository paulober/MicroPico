...
from typing import NoReturn, overload, Optional, Union
...
class mmap(Iterable[int], Sized):
    if sys.platform == "win32":
        def __init__(self, fileno: int, length: int, tagname: Optional[str] = ..., access: int = ..., offset: int = ...) -> None: ...
    else:
        def __init__(
    ...
    def __delitem__(self, __index: Union[int, slice]) -> NoReturn: ...
    @overload
